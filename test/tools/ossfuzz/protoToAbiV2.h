...
{
public:
	virtual ~SolProtoTypeVisitor() = default;

	virtual bool visit(BoolType const& _node) { return visitNode(_node); }
	virtual bool visit(IntegerType const& _node) { return visitNode(_node); }
	virtual bool visit(FixedByteType const& _node) { return visitNode(_node); }
	virtual bool visit(AddressType const& _node) { return visitNode(_node); }
	virtual bool visit(ValueType const& _node);
	virtual bool visit(DynamicByteArrayType const& _node) { return visitNode(_node); }
	virtual bool visit(ArrayType const& _node) { return visitNode(_node); }
	virtual bool visit(StructType const& _node) { return visitNode(_node); }
	virtual bool visit(NonValueType const& _node);
	virtual bool visit(Type const& _node);

	virtual void endVisit(BoolType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(IntegerType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(FixedByteType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(AddressType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(ValueType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(DynamicByteArrayType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(ArrayType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(StructType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(NonValueType const& _node) { return endVisitNode(_node); }
	virtual void endVisit(Type const& _node) { return endVisitNode(_node); }
...
protected:
	...
	virtual bool visitNode(SolProtoType const&) { return true; }

	/// Generic function called by default for each node, to be overridden by derived classes
	/// if behaviour unspecific to a node type is desired.
	virtual void endVisitNode(SolProtoType const&) {}
private:
	static unsigned constexpr s_maxArrayLength = 4;
	static unsigned constexpr s_maxArrayDimensions = 4;
	static unsigned constexpr s_maxDynArrayLength = 256;
